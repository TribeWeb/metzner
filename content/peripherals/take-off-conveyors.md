...
- To assist high-volume material production that requires jam-free stacking.
...
Metzner MA stackers use a driven transport belt to stack processed material straight and without jams. Each unit features a batch tray and a separate collection tray so production continues automatically while the previous batch is removed - preventing batch mixing and reducing operator intervention.

Available as standalone units but typically integrated with Metzner cutting machines, the MA series increases line autonomy and throughput on production lines. Models are compatible with all Metzner cutters, with multiple models designed for a wide range of extrusion types and diameters. Select from:
